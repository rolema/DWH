...
<title>Compras por Cuenta</title>
</head>
...
<div class="principal">
	...
	<form class="menu1" id="menu_1" name="formaProductos"  action="javascript:MostrarDatos();" method="post">
        ...
        <div id="espacio">
			<h1 class="espacio">
				<p><span>C</span>ompras por Cuenta</h1></p>
		</div>
		...
		<input name="Consultar" type="button"  class="consular_p_G_M" id="ConsultarCompras" value="Consultar"  onclick="drawChart()"/>
		...
		<div id="rb3_C">
  			<label>Total</label>
  			<input type="text" name="TotalCompras" id="edTotalCompra" align="right" readonly/>
  		</div>
