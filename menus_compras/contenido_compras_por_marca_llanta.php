...
<title>Compras de Llantas por Marca-Estatus</title>
</head>
...
<div class="principal">
	...
	<form class="menu1" id="menu_1" name="formaProductos" action="javascript:MostrarDatos();" method="post">
		<div id="espacio">
			<h1 class="espacio">
				<p><span>C</span>ompra de Llantas por Marca-Estatus</h1></p>
		</div>
		...
		<input  name="Consultar" type="button"  class="consular_p_G_C" id="ConsultarCompraLlantaME" value="Consultar" />
            	
        <input type="reset" name="limpia" id="limpia_G" class="limpia_G_C" value="Restablecer" />
 		
        <div id="topp_C">
        	<label >Tipo de Compra</label>
        	<select id="TipoCompraLlanta">
