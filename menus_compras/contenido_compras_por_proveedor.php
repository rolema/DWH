...
<div class="principal">
	...
	<form class="menu1" id="menu_1" name="formaProductos" action="javascript:MostrarDatos();" method="post">
		<div id="espacio">
			<h1 class="espacio">
				<p><span>C</span>ompras por Proveedor</h1></p>
		</div>
		...
		<input  name="Consultar" type="button"  class="consular_p_G_C" id="ConsultarCompraProveedor" value="Consultar" />
        <input  name="ConsultarTodo" type="button"  class="btnExcel_C" id="ConsultarProvedorTodo" value="Consultar Todo" />
        ...
        <div id="top_cosulta_C">
        	...
        	<select id="TipoConsulta">
  				...
  				<option value="2">Maximo 250 Proveedores</option>
  			</select>
        </div>
