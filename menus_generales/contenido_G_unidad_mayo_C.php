...
<title>Unidad con Mayor Consumo</title>
</head>
...
<div class="principal">
	...
	<form class="menu1" id="menu_1" name="formaProductos"  action="javascript:MostrarDatos();" method="post">
        ...
        <div id="espacio">
			<h1 class="espacio">
				<p><span>U</span>nidades con Mayor Consumo de Productos</h1></p>
		</div>
		...
		<input name="Consultar" type="button"  class="consular_p_G_M" id="ConsultarUnidadConsumo" value="Consultar"  onclick="drawChart()"/>
        ...
        <input type="reset" name="limpia" id="limpia_G" class="limpia_G_M" value="Restablecer" />
 		...
 		<div id="topp">
        	...
        	<select id="TipoConsulta">
  				...
  				<option value="2">Todas la Unidades</option>
  			</select>
        </div>
