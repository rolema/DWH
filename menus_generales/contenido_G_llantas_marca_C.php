...
<title>Consumo de Llantas por Marca</title>
</head>
...
<div class="principal">
	...
	<form class="menu1" id="menu_1" name="form1"  action="javascript:MostrarDatos();">
		<div id="espacio">
			<h1 class="espacio">
				<p><span>C</span>onsumo de Llantas por Marca</h1></p>
		</div>
        ...
        <input  name="Consultar" type="button"  class="consular_p_G_M" id="ConsultarLlantaMarca" value="Consultar" />
    	<!--<input type="submit" name="btnExcel" id="btnExcel" class="btnExel_G" value="Excel"  onclick="document.form1.action='../Code_Excel/ExcelDatosMarca.php'; document.form1.submit();"s/>-->
        <input type="reset" name="limpia" id="limpia_G" class="limpia_G_M" value="Restablecer" />
         ...
         <div id="topp">
        	...
        	<select id="TipoConsulta">
  				...
  				<option value="2">Todas las marcas</option>
  			</select>
        </div>
    
		<div id="rb3_G_M">
  			<label>Total</label>
  			<input type="text" name="edTotalLlantaMarca" id="edTotalLlantaMarca" align="right" readonly/>
  		</div>
		...
		<!--<div id="tabla_G" class="CSSTableGenerator"> 
